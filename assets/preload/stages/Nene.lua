function onCreate()
		...
		makeLuaSprite('sky','Nene/Day/sky', -100, 00);
		setLuaSpriteScrollFactor('sky', 0.1, 0.1);
		
		makeLuaSprite('city','Nene/Day/city', -10, 0);
		setLuaSpriteScrollFactor('city', 0.3, 0.3);
		scaleObject('city', 0.85, 0.85);
	
		makeLuaSprite('behindTrain','Nene/Day/behindTrain', -40, 50);
		makeLuaSprite('street','Nene/Day/street', -40, 50);
		makeLuaSprite('train','Nene/Day/train',  2000, 360);
        
		makeLuaSprite('blue', 'Nene/Day/win0',-10, 0);
        setLuaSpriteScrollFactor('blue', 0.3, 0.3);		
	    scaleObject('blue',0.85, 0.85)
		
		makeLuaSprite('green', 'Nene/Day/win1',-10, 0);
        setLuaSpriteScrollFactor('green', 0.3, 0.3);		
	    scaleObject('green',0.85, 0.85)
		makeLuaSprite('pink', 'Nene/Day/win2',-10, 0);
        setLuaSpriteScrollFactor('pink', 0.3, 0.3);		
	    scaleObject('pink',0.85, 0.85)
		
		makeLuaSprite('red', 'Nene/Day/win3',-10, 0);
        setLuaSpriteScrollFactor('red', 0.3, 0.3);		
	    scaleObject('red',0.85, 0.85)
	    
		makeLuaSprite('yellow', 'Nene/Day/win4',-10, 0);

function onCreate()
		...
		makeLuaSprite('sky','Nene/Night/sky', -100, 00);
		setLuaSpriteScrollFactor('sky', 0.1, 0.1);
		
		makeLuaSprite('city','Nene/Night/city', -10, 0);
		setLuaSpriteScrollFactor('city', 0.3, 0.3);
		scaleObject('city', 0.85, 0.85);
	
		makeLuaSprite('behindTrain','Nene/Night/behindTrain', -40, 50);
		makeLuaSprite('street','Nene/Night/street', -40, 50);
		makeLuaSprite('train','Nene/Night/train',  2000, 360);
        
		makeLuaSprite('blue', 'Nene/Night/win0',-10, 0);
        setLuaSpriteScrollFactor('blue', 0.3, 0.3);		
	    scaleObject('blue',0.85, 0.85)
		
		makeLuaSprite('green', 'Nene/Night/win1',-10, 0);
        setLuaSpriteScrollFactor('green', 0.3, 0.3);		
	    scaleObject('green',0.85, 0.85)
		makeLuaSprite('pink', 'Nene/Night/win2',-10, 0);
        setLuaSpriteScrollFactor('pink', 0.3, 0.3);		
	    scaleObject('pink',0.85, 0.85)
		
		makeLuaSprite('red', 'Nene/Night/win3',-10, 0);
        setLuaSpriteScrollFactor('red', 0.3, 0.3);		
	    scaleObject('red',0.85, 0.85)
	    
		makeLuaSprite('yellow', 'Nene/Night/win4',-10, 0);
